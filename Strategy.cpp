...
class OperationRemainder:public Strategy {
...
int main() {
  ...
  OperationRemainder remainder_strategy;
  context.changeStrategy(&remainder_strategy);
  cout << "10 % 9 = ";
  cout << context.executeStrategy(10, 9);
  cout << "\n";
}
